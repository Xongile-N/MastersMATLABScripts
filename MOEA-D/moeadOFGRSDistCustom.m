...
setChoice=1;
overHeadThresh=10;
costNames={'Overhead';    'Computational Cost'};
%% Problem Definition

CostFunction=@(x) FritchmanRSCostOFGDistCustom(setChoice,chosenDegs,x,K,overHeadThresh);  % Cost Function

nVar=length(chosenDegs);             % Number of Decision Variables
...
nPop=2*K;    % Population Size (Number of Sub-Problems)
