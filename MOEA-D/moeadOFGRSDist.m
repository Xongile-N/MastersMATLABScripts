...
CostFunction=@(x) FritchmanRSCostOFGDist(setChoice,x,K,overHeadThresh);  % Cost Function

nVar=K;             % Number of Decision Variables
...
nPop=K*5;    % Population Size (Number of Sub-Problems)
