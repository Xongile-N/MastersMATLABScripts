...
CostFunction=@(x) FritchmanRSCostOFG(setChoice,x,K,overHeadThresh);  % Cost Function
...
plotGenerations=[1,25,50,75,100, 125,150]
...
for it=1:MaxIt
    ...
    % Plot EP
   % figure(1);
   if(ismember(it,plotGenerations))
    legendString=PlotCosts(EP,costNames,it,legendString);
    pause(0.01);
   end
