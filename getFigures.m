...
day1='20200729_Weather_1000_24h.mat';
day2='20200731_Weather_1000_24h.mat';
day3='20200801_Weather_1200_24h.mat';
filenameWeather = day3;   %as appropriate
...
%     yyaxis right
%     plot(perpWS)
%         ylabel("Perpendicular Wind Speed(m/s)")
    ...
    [estTR,estE] = hmmtrain(errSeq.',trans_hat,emis_hat,'Symbols',symbols,'Verbose',true,'Tolerance',tol,'maxIterations',maxIter);
    [estTRH,estEH] = hmmtrain(errSeqH.',trans_hat,emis_hat,'Symbols',symbols,'Verbose',true,'Tolerance',tol,'maxIterations',maxIter);


    [errSeqF,~]=hmmgenerate(length(errSeq),estTR,estE,'Symbols',symbols);
    [errSeqHF,~]=hmmgenerate(length(errSeqH),estTRH,estEH,'Symbols',symbols);
    [~, EFRF, ~,~] = runLengthDisitrbution(errSeqF.');
...
%     graphplot(mcH,'ColorEdges',true,'LabelEdges',true);
    ...
    wH=histH.BinWidth;
    xHAdj=xH(1:end-1)+wH;
   %save("data.mat","x","y","w","xAdj","xH","yH","wH","xHAdj","tailored","tailoredH","errSeq","errSeqnf","errSeqH","errSeqnfH","errSeqnfH","errSeqH","estTR","estTRH","estE","estEH","filename","testChoice","avgBER","perpWS" )
